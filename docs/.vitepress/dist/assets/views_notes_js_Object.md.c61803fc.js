import{_ as s,c as n,o as a,V as l}from"./chunks/framework.f518e559.js";const A=JSON.parse('{"title":"Object 对象","description":"","frontmatter":{"title":"Object 对象","config":{"dir":true}},"headers":[],"relativePath":"views/notes/js/Object.md"}'),p={name:"views/notes/js/Object.md"},o=l(`<h3 id="剩余参数rest" tabindex="-1">剩余参数rest <a class="header-anchor" href="#剩余参数rest" aria-label="Permalink to &quot;剩余参数rest&quot;">​</a></h3><p>对象和数组都可以用这种方法</p><div class="language-js"><button title="Copy Code" class="copy"></button><span class="lang">js</span><pre class="shiki material-theme-palenight has-highlighted-lines"><code><span class="line"><span style="color:#C792EA;">let</span><span style="color:#A6ACCD;"> object </span><span style="color:#89DDFF;">=</span><span style="color:#A6ACCD;"> </span><span style="color:#89DDFF;">{</span></span>
