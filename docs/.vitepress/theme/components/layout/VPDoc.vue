<script setup lang="ts">
  ...
  const password = computed(() => {
    if (
      pageConfig.value.frontmatter.password === true &&
      themeConfig.value.password
    ) {
      return themeConfig.value.password
    } else if (pageConfig.value.frontmatter.password) {
      return pageConfig.value.frontmatter.password
    }
