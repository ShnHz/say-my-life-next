...
var errorTip = (message) => {
  throw new Error(message);
};
var checkKeyIsNull = (obj) => {
  const props = {
    output: "",
    type: "",
    isEnd: false,
...
var lib_default = EasyTyper;
export {
  lib_default as default
};
//# sourceMappingURL=easy-typer-js.js.map
